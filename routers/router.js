...
router.post("/books/add", isLoggedIn, isAdmin, Controller.saveAddBook);
...
router.get("/profile/:id", isLoggedIn, Controller.showEditProfile);
router.post("/profile/:id", isLoggedIn, Controller.saveEditProfile);
...
router.get("/books/:id/delete", isLoggedIn, isAdmin, Controller.deleteBookbyId);
